...
BBObject* BBObject::CreateObject(IGraphics& a_Gfx, BBE::GLTFNode* Node, Model* a_Model, Transform& a_ObjectTransform, const char* a_Name)
{
	BBObject* obj = new BBObject(a_Name);
